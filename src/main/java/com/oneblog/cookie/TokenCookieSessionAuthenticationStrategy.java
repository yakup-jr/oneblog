...
public class TokenCookieSessionAuthenticationStrategy implements SessionAuthenticationStrategy {
	...
	private Function<Authentication, com.oneblog.cookie.Token> tokenCookieFactory = new DefaultTokenCookieFactory();
	...
	public void onAuthentication(
		...
		if (authentication instanceof UsernamePasswordAuthenticationToken) {
			...
			cookie.setMaxAge(
				Integer.parseInt(String.valueOf(ChronoUnit.SECONDS.between(Instant.now(), token.expiresAt()))));
