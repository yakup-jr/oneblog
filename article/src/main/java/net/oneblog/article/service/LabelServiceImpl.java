...
public class LabelServiceImpl implements LabelService {
	...
	public LabelEntity save(LabelEntity labelEntity) throws ApiRequestException {
		...
		LabelName newLabelName =
			Arrays.stream(LabelName.values()).filter(labelName -> labelName.equals(labelEntity.getName())).findFirst().get();
	...
	@Override
	public List<LabelEntity> findLabels(List<LabelEntity> labelEntities) throws LabelNotFoundException {
