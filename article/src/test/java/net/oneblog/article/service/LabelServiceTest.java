...
public class LabelServiceTest {
	...
	public void saveLabel_ReturnLabel() {
		...
		LabelEntity
			outputLabelEntity = LabelEntity.builder().name(inputLabelEntity.getName()).labelId(1L).build();
	...
	public void saveLabel_ThrowServiceException() {
		LabelEntity inputLabelEntity = LabelEntity.builder().name(LabelName.Assembler).build();
		LabelEntity
			outputLabelEntity = LabelEntity.builder().name(inputLabelEntity.getName()).labelId(0L).build();
	...
	public void deleteById_ReturnLabel() {
		...
		assertThat(labelEntity).isNotNull().isInstanceOf(LabelEntity.class).isEqualTo(repositoryResponse.get());
	}
